...
/**
 * UpdateProductPayloadBase
 * auto generated base class for the model UpdateProductPayloadModel.
 */
export const UpdateProductPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('UpdateProductPayload')
  .props({
    __typename: types.optional(types.literal("UpdateProductPayload"), "UpdateProductPayload"),
...
export class UpdateProductPayloadModelSelector extends QueryBuilder {
...
export function selectFromUpdateProductPayload() {
  return new UpdateProductPayloadModelSelector()
}

export const updateProductPayloadModelPrimitives = selectFromUpdateProductPayload().numUids
