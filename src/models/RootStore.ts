...
import { saleModelSelector } from "./SaleModel";
...
export const RootStore = RootStoreBase
  .actions(self => ({
    ...
    fetchAllProducts(filter = {}) {
      ...
      const selector = productModelPrimitives.toString();
      return self.queryQueryProduct(variables, selector);
    }
    ,
    fetchSalesByDate(startDate, endDate, categoryFilter = {}) {
      ...
      return self.queryQuerySale(variables, saleModelSelector.toString());
    }
  }))
